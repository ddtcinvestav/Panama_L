module seq_det (
  ...
  // Registro de estado (Lógica secuencial con reset asíncrono activo en bajo)
  ...
  // Lógica de próximo estado (Lógica combinacional)
  always_comb begin
    case (state)
      ...
      // Estado de detección con solapamiento (Overlapping)
